...
data class CountryCode(
    ...
    val countryNameLocal: String,
    val countryCode: String,
    val currencyCode: String,
    val currencyNameEn: String,
    val tinType: String,
    val tinName: String,
    val officialLanguageCode: String,
    val officialLanguageNameEn: String,
    val officialLanguageNameLocal: String,
...
val BLACK_LISTED_COUNTRIES = listOf(
    "AG",
    "AI",
    "AS",
    "GD",
...
val PRIORITY_COUNTRIES = listOf("IN", "US", "BD", "SG", "MY", "AE");

private val _countryCodes = listOf(
    CountryCode(
...
val COUNTRY_CODES =
    _countryCodes.filter { it.countryCode !in BLACK_LISTED_COUNTRIES }.sortedBy { it.countryNameEn }
        .sortedBy { if (it.countryCode in PRIORITY_COUNTRIES) 0 else 1 }
